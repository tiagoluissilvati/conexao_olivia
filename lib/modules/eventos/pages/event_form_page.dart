...
class _EventFormPageState extends State<EventFormPage> {
  ...
  void initState() {
    ...
    // Inicializar controladores com dados do store
    _setupControllers();
  }
  ...
  void _setupControllers() {
    ...
    // Listeners para atualizar o store quando os campos mudam
  ...
  String _formatTimeForInput(String timeString) {
    ...
    // Se contém segundos (HH:MM:SS), remover
  ...
  Future<void> _saveEvent() async {
    ...
    try {
      ...
      if (formStore.isEditing) {
        success = await eventStore.updateEvent(event);
      } else {
        success = await eventStore.createEvent(event);
      }
